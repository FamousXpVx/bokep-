...
try:
    ...
    print(f"Modul {str(e)} belum terinstal. Menginstal modul...")
    os.system('pip install ' + str(e.name))
    print(f"{str(e)} berhasil diinstal.")
    # Menyembunyikan pesan pemasangan pip
...
YMMMUP^	
                 BotNet	
                   V : 0.0.1	
              MADE BY : MrVxdx1-Xploit	
             TEAM  : Ketapang Cyber Team	
"""	
